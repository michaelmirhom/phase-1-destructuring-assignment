...
const {cow: bessie, sheep: dolly, pig: babe, chicken: little} = {cow: 'cow', sheep: 'sheep', pig: 'pig', chicken: 'chicken'};
// 2. Bolt the horse wandered off, so just give us four animals, and let's name them bessie, dolly, babe, and little.
const {cow: blackAndWhite, sheep: black, pig: pink} = {cow: 'cow', sheep: 'sheep', pig: 'pig'};
...
//const{nestedName}=nestedMuppet.nestedName;
